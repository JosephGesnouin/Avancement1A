...
Maghoumi et\textit{ al.}\cite{maghoumi2019deepgru} proposent 
...
Shukla et\textit{ al.}\cite{shukla2017recurrent} proposent une architecture récurente hierarchique sensiblement équivalente à \cite{du2015hierarchical} mais réduisent le nombre de jointures en entrée du modèle. Conduisant à un ensemble réduit de paramètres réduisant le temps d'inférence sans dégrader la qualité du classificateur.
