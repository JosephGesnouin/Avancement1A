...
Ces dernières années, les réseaux de neurones récurrents ont  été les approches de référence pour la modélisation de séquences. La plupart des approches d'apprentissage profond pour la reconnaissance de gestes utilisent des cellules récurrentes 

ce qui explique pourquoi la plupart des approches d'apprentissage profond pour la reconnaissance des gestes utilisent des cellules récurrentes comme la cellule de mémoire à long terme (LSTM) introduite par Hochreiter et Schmidhuber (1997) ou la cellule d'unité récurrente à portes (GRU) introduite par Cho et al. (2014).
