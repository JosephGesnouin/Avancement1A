...
Les approches convolutives deviennent une solution intéressante compte tenu de leurs avantages en matière de parallélisation, d'efficacité dans l'apprentissage des caractéristiques et 
...
En outre, les données squelettiques sont des éléments de faible dimension. Il est naturel d'organiser une séquence de caractéristiques du squelette de manière chronologique dans une image, qui conserve les informations originales
