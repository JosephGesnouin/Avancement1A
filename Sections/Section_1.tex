...
Les principales modalités utilisées pour la reconnaissance d'actions humaines comprennent les vidéos RGB dans leur globalité \cite{donahue2015long,2014arXiv1412.0767T}, le flow optique \cite{simonyan2014two,zhang2016real,DanutPOP} et la réprésentation sous forme de squelette.
