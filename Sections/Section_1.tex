...
La seconde étape de l'approche consistera en la classification des actions de la personne en fonction de la dynamique de sa pose. La reconnaissance de l'action humaine dans une vidéo est un sujet de recherche difficile de par la grande variation et la complexité des données en entrée.
...
A la vue de notre problématique, nous nous sommes majoritairement intéréssé à la dernière catégorie d'approches.

En réduisant la taille des données d'entrée grâce à la structure de données associée aux squelettes, ce type d'approche est considéré comme bien plus rapide computationellement parlant que les méthodes listées précédement.
