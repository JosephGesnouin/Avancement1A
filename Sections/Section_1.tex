...
pb spatio temporel -> comment le traiter? en gros lister les familles de action reco for skel
...
Ainsi, Ke et\textit{ al.} \cite{ke2017new} proposent de transformer une séquence squelette sous la forme de trois clips vidéos, les caractéristiques des CNN des trois clips sont alors fusionés en un unique vecteur de caractéristiques envoyé dans une couche softmax pour la classification.
Pham et\textit{ al.} \cite{pham2018learning}
