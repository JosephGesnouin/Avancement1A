...
Luong et \textit{al.}\cite{luong2015effective} distingue deux types d'attention: \textit{soft attention} et \textit{hard attention}:
 \begin{itemize}
...
L'évolution du squelette du corps humain au cours du temps peut être considérée comme un graphe dynamique. Cependant, la recherche en apprentissage profond pour la reconnaissance d'actions sur des données squelettiques s'est jusqu'à présent principalement concentrée sur des données euclidiennes (format grille tel une image).
