...
\begin{figure}[H]
    ...
    \caption{En haut: Un exemple d'approche Top down. En bas: Un exemple d'approche Bottom up (\textit{https://github.com/JosephGesnouin/Jupyters\_Nocode\_YolOpenpose})}
