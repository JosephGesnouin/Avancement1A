...
D'autres approches à base de CNN, les utilisent en tant que CNN 1D:
...
Ainsi, Li et al.(2017)\cite{li2017skeleton} proposent une approche où LSTM et CNN sont fusionnés "tardivement" (late fusion). Ullah et al.(2017)\cite{ullah2017action} proposent un approche 
