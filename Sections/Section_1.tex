...
\cite{2019arXiv191207148G} et \cite{xu2019prediction} proposent par exemple d'utiliser des GANs pour générer la suite de l'action et la classifier,\cite{runsheng2017predictive} utilisent un auto-encodeur variationel. 
