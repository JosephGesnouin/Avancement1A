...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{Images/Johansson.png}
    \caption{Un exemple de stimuli de l'experience de Johansson \cite{johansson1973visual,johansson1976spatio}}
    \label{fig:Johansson}
\end{figure}
