...
DD-Net (filtres \= 64, w/o global slow motion)                           & 1.76M                & 92.7\%               & 90.2\%                \\
DD-Net (filtres \= 64, w/o global fast)                                  & 1.76M                & 93.3\%               & 90.5\%                \\
...
DFS-DD-Net (filtres \= 64, w/o global slow motion)                       & M                    & \%                   & \%                    \\
DFS-DD-Net (filtres \= 64, w/o global fast)                              & M                    & \%                   & \%                    \\
DFS-DD-NET (filtres \= 64)                                               & 1.84M                    & \%                   & \%                    \\
