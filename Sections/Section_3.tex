...
\caption{Résulats obtenus sur SHREC \cite{de2017shrec} (Squelettes de main 3D)}
\end{table}
...
\end{tabular}}
\caption{Résulats obtenus sur JHMDB \cite{jhuang2013towards} (Squelettes corps humain 2D)}
\end{table}
