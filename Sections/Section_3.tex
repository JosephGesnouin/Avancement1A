...
Souhaitant m'intéresser à l'importance de la représentation pour la classification d'actions et à la plus value apportée par celle-ci, j'ai souhaité me comparer à un modèle de classification existant dans les mêmes conditions experimentales. Je me suis donc basé sur l'approche experimentale de Double-feature Double-motion Network \cite{2019arXiv190709658Y}.
...
\begin{tabular}{l|l|l} 
\hline
\textbf{Méthode }                                                       & \textbf{Paramètres}  & \textbf{14 classes } \\ 
\hline
DD-NET (filtres \= 64)                                                   & 1.82M                & 94.6\%                \\
DD-NET (filtres \= 32)                                                   & 0.50M                & 93.5\%                \\
DD-NET (filtres \= 16)                                                   & 0.15M                & 91.8\%                 \\
                                                                        &                      &                                      \\ 
\hline
DFS-DD-NET (filtres \= 64)                                               & 1.84M                    & 95.7\%                    \\
DFS-DD-NET (filtres \= 32)                                               & 0.51M                    & 95.5\%                 \\
DFS-DD-NET (filtres \= 16)                                               & 0.16M                & 93.1\%                    \\
\hline
\end{tabular}
}
