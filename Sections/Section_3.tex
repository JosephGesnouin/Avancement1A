...
\textbf{Réseau}                                 & \textbf{Nb Params} & \textbf{SHREC 14} & \textbf{SHREC 28} & \textbf{FPS}  \\ 
\hline
Sans initialisation                      &          1.2M &         91.2\% &          &     20 000 \\
Avec initialisation AE classique (\lambda = 0)        &          1.2M &          91.5\%&          &      20 000\\
Avec initialisation AE Modifié (\lambda = 5)          &          1.2M &          92.5\%&          &      20 000\\
