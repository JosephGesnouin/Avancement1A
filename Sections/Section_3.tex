...
\hline
Sans initialisation                      &          1.2M &         91.2\% &          &     20 000 \\
Avec initialisation AE classique (\lambda = 0)        &          1.2M &          91.5\%&          &      -\\
Avec initialisation AE Modifié (\lambda =1) &          1.2M &          91.9\%&          &      -\\
Avec initialisation AE Modifié (\lambda = 2.5) &           1.2M&          92.4\%&          &     -\\
Avec initialisation AE Modifié (\lambda = 5)          &          1.2M &          \textbf{92.5\%}&          &      -\\
