...
\end{tabular}}
\caption{Résulats obtenus grâce à la normalisation DFS sur SHREC JHMDB \cite{jhuang2013towards} (Squelettes corps humain 2D) pour un réseau convolutif 2D: Lenet.}
\end{table}
